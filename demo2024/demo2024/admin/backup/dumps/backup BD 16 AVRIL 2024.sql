...
CREATE FUNCTION public.ajout_maison(p_titre text, p_type text, p_surface integer, p_prix integer, p_annee_construction integer, p_adresse text, p_ville text, p_cp text, p_idagent integer, p_image text) RETURNS integer
    LANGUAGE plpgsql
    AS '
DECLARE
    id INTEGER;
...
BEGIN
    ...
    IF NOT FOUND THEN
        ...
        VALUES (p_titre, p_type, p_surface, p_prix, p_annee_construction, p_adresse, p_ville, p_cp, p_idagent, p_image)
        RETURNING id_maison INTO id;
...
--
-- TOC entry 4720 (class 2604 OID 17095)
...
--
-- TOC entry 4716 (class 2604 OID 17051)
...
--
-- TOC entry 4717 (class 2604 OID 17060)
...
--
-- TOC entry 4715 (class 2604 OID 17042)
...
--
-- TOC entry 4718 (class 2604 OID 17069)
...
--
-- TOC entry 4719 (class 2604 OID 17083)
...
--
-- TOC entry 4891 (class 0 OID 17092)
-- Dependencies: 226
...
--
-- TOC entry 4883 (class 0 OID 17048)
-- Dependencies: 218
...
--
-- TOC entry 4885 (class 0 OID 17057)
-- Dependencies: 220
...
--
-- TOC entry 4881 (class 0 OID 17039)
-- Dependencies: 216
...
--
-- TOC entry 4887 (class 0 OID 17066)
-- Dependencies: 222
...
INSERT INTO public.maison (id_maison, titre_maison, type_maison, surface, annee_construction, adresse, ville, cp, id_agent, image_maison, prix) VALUES (6, 'Maison en banlieue', 'Maison individuelle', 300, 1995, '789 Boulevard de la Mer', 'Marseille', '13001', 5, 'banlieue.jpg', 700000);
...
INSERT INTO public.maison (id_maison, titre_maison, type_maison, surface, annee_construction, adresse, ville, cp, id_agent, image_maison, prix) VALUES (22, 'Appartement de luxe', 'Appartement', 150, 2024, 'Rue du Tir', 'MONS', '7130', 1, 'C:\fakepath\ajout_image.jpg', 200000);
INSERT INTO public.maison (id_maison, titre_maison, type_maison, surface, annee_construction, adresse, ville, cp, id_agent, image_maison, prix) VALUES (23, 'aaa', 'bbbb', 100, 2024, 'ccccc', 'ddddd', 'eeeeee', 1, 'agent1.jpg', 100000);


--
-- TOC entry 4889 (class 0 OID 17080)
-- Dependencies: 224
...
SELECT pg_catalog.setval('public.maison_id_maison_seq', 23, true);
...
--
-- TOC entry 4724 (class 2606 OID 17055)
...
--
-- TOC entry 4726 (class 2606 OID 17064)
...
--
-- TOC entry 4722 (class 2606 OID 17046)
...
--
-- TOC entry 4728 (class 2606 OID 17073)
...
--
-- TOC entry 4730 (class 2606 OID 17085)
...
--
-- TOC entry 4735 (class 2606 OID 17098)
...
--
-- TOC entry 4736 (class 2606 OID 17103)
...
--
-- TOC entry 4733 (class 2606 OID 17074)
...
--
-- TOC entry 4734 (class 2606 OID 17086)
...
-- Completed on 2024-04-16 16:34:25
